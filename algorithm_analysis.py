...
if __name__ == "__main__":
    ...
    if algorithm == "deep_q_learning_continues_and_experience_replay":
        deep_q_learning_obj = deep_q_learning_algorithm(episode = 100, algorithm_name="deep_q_learning")
        ...
        deep_q_learning_obj = deep_q_learning_algorithm(episode = 100, algorithm_name="double_deep_q_learning")
        deep_q_learning_obj.double_deep_q_learning()
   
    elif algorithm == "dueling_deep_q_learning_continues_and_experience_replay":
        deep_q_learning_obj = deep_q_learning_algorithm(episode = 100, algorithm_name="dueling_deep_q_learning")
